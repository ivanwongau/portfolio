        ...
        <div class="articles form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('article_img', ['label' => 'Article Image (Optional)']);
                    echo "To add an article image, please copy the image address from the internet.";
                    echo $this->Form->control('article_desc', ['label' => 'Description']);
                    echo $this->Form->control('article_detail', ['label' => 'Content', 'type' => 'textarea']);
