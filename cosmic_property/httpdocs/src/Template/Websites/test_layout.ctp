            ...
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <div data-aos="fade-up" data-aos-delay="600">
                    <div class="text-center text-lg-start">
                        <a href="/108/websites/aboutus" class="btn-learn-more scrollto d-inline-flex align-items-center justify-content-center align-self-center">
...
<section id="values" class="values">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
                <div class="back figures col-lg-4">
                ...
                <div class="back figures col-lg-4 mt-4 mt-lg-0">
