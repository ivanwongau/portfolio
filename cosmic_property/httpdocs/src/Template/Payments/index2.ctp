...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <!--            <h2 class="w3-text-blue">Payment Confirmation Page</h2>-->
            <h4><b>Building Name : </b> <?php echo $building_data[0]->property_name ?></h4>
            <h4><b>Building Address
                    : </b> <?php echo $building_data[0]->street_number.' '.$building_data[0]->street_name . ', ' . $building_data[0]->city . ', ' . $building_data[0]->state . ', ' . $building_data[0]->postcode ?>
            </h4>
            <h4><b>Commencement Date of the Subscription
                    : </b> <?php echo $subsArray['commencement_date']['day'] . '-', $subsArray['commencement_date']['month'], '-' . $subsArray['commencement_date']['year'] ?>
            </h4>
            <h4><b>End Date
                    : </b> <?php echo $subsArray['end_date']['day'] . '-', $subsArray['end_date']['month'], '-' . $subsArray['end_date']['year'] ?>
            </h4>
            <h4><b>Final Price : </b> <?php echo '$' . $value ?></h4>


            <!--<label class="w3-text-blue"><b>Enter Amount</b></label>-->
            <?php echo $this->Form->hidden(__('amount'), ['class' => 'form-control', 'value' => $value], array('type' => 'button', 'class' => 'btn  btn-secondary')) ?>
        </div>
        <br>
        <div class="d-flex">
            <div class="p-2">
