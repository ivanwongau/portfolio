...
class SubscriptionsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('forecast_period_display')
            ->notEmptyString('forecast_period_display')
            ->lessThanOrEqual('forecast_period_display',20,'The maximum value is 20')
            ->greaterThanOrEqual('forecast_period_display',1,'The minimum value is 1');

        $validator
            ->integer('forecast_in_advance')
            ->notEmptyString('forecast_in_advance');
